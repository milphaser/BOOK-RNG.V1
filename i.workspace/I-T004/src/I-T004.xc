 ...
 *
 *		Примерът цели да се провери възможността за използване на
 *		вградения в оператора на CSP за алтернативен избор недетерминизъм.
 *
 *		Алтернативният избор се реализира от оператора select на XC,
 *		в основата на който е апаратния механизъм на архитектурата XS1
 *		за обработка на събитията.
 *
 *		Както показва експериментът обаче, в апаратната реализация на
 *		оператора select липсва очаквания недетерминизъм и се получава
 *		периодичен вместо случаен сигнал.
 *
 *
 */
